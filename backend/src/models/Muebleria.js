...
export const Customer = sequelize.define(
  "muebleria_customers",
  {
    ...
    secondName: { type: DataTypes.STRING(60), allowNull: true },
    firstLastName: { type: DataTypes.STRING(60), allowNull: true },
    secondLastName: { type: DataTypes.STRING(60), allowNull: true },
    birthDate: { type: DataTypes.DATEONLY, allowNull: true },
    documentType: {
      type: DataTypes.ENUM("cedula", "pasaporte", "otro"),
      allowNull: true,
      defaultValue: "cedula",
    },
    documentNumber: { type: DataTypes.STRING(40), allowNull: true },
